...
class ConstantesGenericasUtil
{
    ...
    public const MSG_ERRO_GENERICO = 'Ocorreu algum erro na requisição, verifique se o login já existe!';
    ...
    public const MSG_ERRO_LOGIN_CEP_OBRIGATORIO = 'Login e CEP são obrigatórios!';
